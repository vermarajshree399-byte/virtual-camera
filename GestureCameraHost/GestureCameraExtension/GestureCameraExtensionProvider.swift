//
//  GestureCameraExtensionProvider.swift
...
class GestureCameraExtensionDeviceSource: NSObject, CMIOExtensionDeviceSource {
	
	private(set) var device: CMIOExtensionDevice!
	
	private var _streamSource: GestureCameraExtensionStreamSource!
	...
	init(localizedName: String) {
		...
		_streamSource = GestureCameraExtensionStreamSource(localizedName: "SampleCapture.Video", streamID: videoID, streamFormat: videoStreamFormat, device: device)
		do {
...
class GestureCameraExtensionStreamSource: NSObject, CMIOExtensionStreamSource {
	...
	func startStream() throws {
		...
		guard let deviceSource = device.source as? GestureCameraExtensionDeviceSource else {
...
class GestureCameraExtensionProviderSource: NSObject, CMIOExtensionProviderSource {
	
	private(set) var provider: CMIOExtensionProvider!
	
	private var deviceSource: GestureCameraExtensionDeviceSource!
	...
	init(clientQueue: DispatchQueue?) {
		...
		deviceSource = GestureCameraExtensionDeviceSource(localizedName: "SampleCapture (Swift)")
